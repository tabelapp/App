...
-- NF: preço praticado na data da nota, visível por 7 dias; encarte vale até a data impressa nele.
insert into public.cotacoes (pdv_nome_livre, pdv_endereco_livre, produto, preco_centavos, validade, fonte,
                             chave_acesso_nf, created_at, data_nf)
values
  ('Mercadinho Alto da Serra', 'Rua Teresa, 1500 - Alto da Serra', 'Arroz Branco Tipo 1 5kg', 2349,
   public.hoje() + 7, 'usuario_nf', '33260911111111000191650010000012341000012346', now() - interval '2 hours', public.hoje()),
  ...
  ('Sacolão Corrêas', 'Estrada União e Indústria, 3000 - Corrêas', 'Banana Prata kg', 599,
   public.hoje() + 4, 'usuario_encarte', null, now() - interval '5 hours', null),
